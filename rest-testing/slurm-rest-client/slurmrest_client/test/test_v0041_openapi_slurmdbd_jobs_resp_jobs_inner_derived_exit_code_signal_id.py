...
class TestV0041OpenapiSlurmdbdJobsRespJobsInnerDerivedExitCodeSignalId(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V0041OpenapiSlurmdbdJobsRespJobsInnerDerivedExitCodeSignalId:
