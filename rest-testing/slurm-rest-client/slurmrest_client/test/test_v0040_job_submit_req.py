...
class TestV0040JobSubmitReq(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V0040JobSubmitReq:
        """Test V0040JobSubmitReq
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V0040JobSubmitReq`
        """
        model = V0040JobSubmitReq()
        if include_optional:
    ...
    def testV0040JobSubmitReq(self):
        """Test V0040JobSubmitReq"""
