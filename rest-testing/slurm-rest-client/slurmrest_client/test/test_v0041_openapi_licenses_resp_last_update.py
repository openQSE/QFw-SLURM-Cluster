...
class TestV0041OpenapiLicensesRespLastUpdate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V0041OpenapiLicensesRespLastUpdate:
        ...
        # uncomment below to create an instance of `V0041OpenapiLicensesRespLastUpdate`
        """
        model = V0041OpenapiLicensesRespLastUpdate()
        if include_optional:
            return V0041OpenapiLicensesRespLastUpdate(
                set = True,
                infinite = True,
                number = 56
            )
    ...
    def testV0041OpenapiLicensesRespLastUpdate(self):
        """Test V0041OpenapiLicensesRespLastUpdate"""
