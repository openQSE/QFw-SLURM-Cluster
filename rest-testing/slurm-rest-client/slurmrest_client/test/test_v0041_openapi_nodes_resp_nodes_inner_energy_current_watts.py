...
class TestV0041OpenapiNodesRespNodesInnerEnergyCurrentWatts(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V0041OpenapiNodesRespNodesInnerEnergyCurrentWatts:
        """Test V0041OpenapiNodesRespNodesInnerEnergyCurrentWatts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V0041OpenapiNodesRespNodesInnerEnergyCurrentWatts`
        """
        model = V0041OpenapiNodesRespNodesInnerEnergyCurrentWatts()
        if include_optional:
            return V0041OpenapiNodesRespNodesInnerEnergyCurrentWatts(
                set = True,
                infinite = True,
                number = 56
            )
    ...
    def testV0041OpenapiNodesRespNodesInnerEnergyCurrentWatts(self):
        """Test V0041OpenapiNodesRespNodesInnerEnergyCurrentWatts"""
