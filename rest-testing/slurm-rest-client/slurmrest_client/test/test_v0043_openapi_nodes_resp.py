...
class TestV0043OpenapiNodesResp(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V0043OpenapiNodesResp:
        """Test V0043OpenapiNodesResp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V0043OpenapiNodesResp`
        """
        model = V0043OpenapiNodesResp()
        if include_optional:
    ...
    def testV0043OpenapiNodesResp(self):
        """Test V0043OpenapiNodesResp"""
