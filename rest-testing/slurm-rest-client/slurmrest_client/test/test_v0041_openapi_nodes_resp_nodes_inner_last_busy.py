...
class TestV0041OpenapiNodesRespNodesInnerLastBusy(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V0041OpenapiNodesRespNodesInnerLastBusy:
        ...
        # uncomment below to create an instance of `V0041OpenapiNodesRespNodesInnerLastBusy`
        """
        model = V0041OpenapiNodesRespNodesInnerLastBusy()
        if include_optional:
            return V0041OpenapiNodesRespNodesInnerLastBusy(
                set = True,
                infinite = True,
                number = 56
            )
    ...
    def testV0041OpenapiNodesRespNodesInnerLastBusy(self):
        """Test V0041OpenapiNodesRespNodesInnerLastBusy"""
