...
class TestV0041OpenapiKillJobsRespStatusInnerJobId(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V0041OpenapiKillJobsRespStatusInnerJobId:
        ...
        # uncomment below to create an instance of `V0041OpenapiKillJobsRespStatusInnerJobId`
        """
        model = V0041OpenapiKillJobsRespStatusInnerJobId()
        if include_optional:
            return V0041OpenapiKillJobsRespStatusInnerJobId(
                set = True,
                infinite = True,
                number = 56
            )
    ...
    def testV0041OpenapiKillJobsRespStatusInnerJobId(self):
        """Test V0041OpenapiKillJobsRespStatusInnerJobId"""
