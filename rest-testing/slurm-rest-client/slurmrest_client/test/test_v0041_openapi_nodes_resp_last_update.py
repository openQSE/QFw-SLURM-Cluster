...
class TestV0041OpenapiNodesRespLastUpdate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V0041OpenapiNodesRespLastUpdate:
        """Test V0041OpenapiNodesRespLastUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V0041OpenapiNodesRespLastUpdate`
        """
        model = V0041OpenapiNodesRespLastUpdate()
        if include_optional:
            return V0041OpenapiNodesRespLastUpdate(
                set = True,
                infinite = True,
                number = 56
            )
