...
class TestV0042StatsMsgRpcQueue(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V0042StatsMsgRpcQueue:
        """Test V0042StatsMsgRpcQueue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V0042StatsMsgRpcQueue`
        """
        model = V0042StatsMsgRpcQueue()
        if include_optional:
            return V0042StatsMsgRpcQueue(
                type_id = 56,
                message_type = '',
                count = 56
            )
    ...
    def testV0042StatsMsgRpcQueue(self):
        """Test V0042StatsMsgRpcQueue"""
