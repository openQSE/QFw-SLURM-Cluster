...
class TestV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsActiveJobsPer(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsActiveJobsPer:
        """Test V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsActiveJobsPer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsActiveJobsPer`
        """
    ...
    def testV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsActiveJobsPer(self):
        """Test V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsActiveJobsPer"""
