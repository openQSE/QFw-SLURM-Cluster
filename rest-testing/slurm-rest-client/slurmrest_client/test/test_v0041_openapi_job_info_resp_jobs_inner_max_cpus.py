...
class TestV0041OpenapiJobInfoRespJobsInnerMaxCpus(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V0041OpenapiJobInfoRespJobsInnerMaxCpus:
        """Test V0041OpenapiJobInfoRespJobsInnerMaxCpus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V0041OpenapiJobInfoRespJobsInnerMaxCpus`
        """
        model = V0041OpenapiJobInfoRespJobsInnerMaxCpus()
        if include_optional:
            return V0041OpenapiJobInfoRespJobsInnerMaxCpus(
                set = True,
                infinite = True,
                number = 56
            )
    ...
    def testV0041OpenapiJobInfoRespJobsInnerMaxCpus(self):
        """Test V0041OpenapiJobInfoRespJobsInnerMaxCpus"""
