...
class TestV0043OpenapiJobInfoResp(unittest.TestCase):
    """V0043OpenapiJobInfoResp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V0043OpenapiJobInfoResp:
        """Test V0043OpenapiJobInfoResp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V0043OpenapiJobInfoResp`
        """
        model = V0043OpenapiJobInfoResp()
        if include_optional:
            return V0043OpenapiJobInfoResp(
                jobs = [
                    openapi_client.models.v0/0/43_job_info.v0.0.43_job_info(
                        account = '', 
                ...
                last_backfill = openapi_client.models.v0/0/43_uint64_no_val_struct.v0.0.43_uint64_no_val_struct(
                    set = True, 
                    infinite = True, 
                    number = 56, ),
    ...
    def testV0043OpenapiJobInfoResp(self):
        """Test V0043OpenapiJobInfoResp"""
