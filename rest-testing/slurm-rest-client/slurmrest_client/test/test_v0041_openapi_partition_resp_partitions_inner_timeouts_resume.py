...
class TestV0041OpenapiPartitionRespPartitionsInnerTimeoutsResume(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V0041OpenapiPartitionRespPartitionsInnerTimeoutsResume:
        """Test V0041OpenapiPartitionRespPartitionsInnerTimeoutsResume
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V0041OpenapiPartitionRespPartitionsInnerTimeoutsResume`
        """
        model = V0041OpenapiPartitionRespPartitionsInnerTimeoutsResume()
        if include_optional:
            return V0041OpenapiPartitionRespPartitionsInnerTimeoutsResume(
                set = True,
                infinite = True,
                number = 56
            )
    ...
    def testV0041OpenapiPartitionRespPartitionsInnerTimeoutsResume(self):
        """Test V0041OpenapiPartitionRespPartitionsInnerTimeoutsResume"""
