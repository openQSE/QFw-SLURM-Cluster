...
class TestV0040OpenapiDiagResp(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V0040OpenapiDiagResp:
        """Test V0040OpenapiDiagResp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V0040OpenapiDiagResp`
        """
    ...
    def testV0040OpenapiDiagResp(self):
        """Test V0040OpenapiDiagResp"""
