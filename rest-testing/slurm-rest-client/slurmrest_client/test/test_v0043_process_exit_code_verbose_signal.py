...
class TestV0043ProcessExitCodeVerboseSignal(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V0043ProcessExitCodeVerboseSignal:
        """Test V0043ProcessExitCodeVerboseSignal
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V0043ProcessExitCodeVerboseSignal`
        """
    ...
    def testV0043ProcessExitCodeVerboseSignal(self):
        """Test V0043ProcessExitCodeVerboseSignal"""
