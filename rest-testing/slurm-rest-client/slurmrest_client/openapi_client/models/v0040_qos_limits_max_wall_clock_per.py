...
class V0040QosLimitsMaxWallClockPer(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "qos": V0040Uint32NoVal.from_dict(obj["qos"]) if obj.get("qos") is not None else None,
            "job": V0040Uint32NoVal.from_dict(obj["job"]) if obj.get("job") is not None else None
        })
        return _obj
