...
class V0040AssocMaxPer(BaseModel):
    """
    V0040AssocMaxPer
    """ # noqa: E501
    account: Optional[V0040AssocMaxPerAccount] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "account": V0040AssocMaxPerAccount.from_dict(obj["account"]) if obj.get("account") is not None else None
        })
        return _obj
