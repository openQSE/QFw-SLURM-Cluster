...
class V0040ProcessExitCodeVerbose(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "return_code": V0040Uint32NoVal.from_dict(obj["return_code"]) if obj.get("return_code") is not None else None,
            "signal": V0040ProcessExitCodeVerboseSignal.from_dict(obj["signal"]) if obj.get("signal") is not None else None
        })
        return _obj
