...
class V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxTresPer(BaseModel):
    ...
    """ # noqa: E501
    account: Optional[List[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequestedMaxInner]] = Field(default=None, description="MaxTRESPerAccount")
    ...
    user: Optional[List[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequestedMaxInner]] = Field(default=None, description="MaxTRESPerUser")
