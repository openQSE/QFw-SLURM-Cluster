...
class V0040ClusterRecAssociations(BaseModel):
    """
    V0040ClusterRecAssociations
    """ # noqa: E501
    root: Optional[V0040AssocShort] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "root": V0040AssocShort.from_dict(obj["root"]) if obj.get("root") is not None else None
        })
        return _obj
