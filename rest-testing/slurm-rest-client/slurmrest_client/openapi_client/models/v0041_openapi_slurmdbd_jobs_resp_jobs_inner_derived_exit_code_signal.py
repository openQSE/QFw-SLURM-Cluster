...
class V0041OpenapiSlurmdbdJobsRespJobsInnerDerivedExitCodeSignal(BaseModel):
    """
    V0041OpenapiSlurmdbdJobsRespJobsInnerDerivedExitCodeSignal
    """ # noqa: E501
    id: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerDerivedExitCodeSignalId] = None
    name: Optional[StrictStr] = Field(default=None, description="Signal sent to process")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": V0041OpenapiSlurmdbdJobsRespJobsInnerDerivedExitCodeSignalId.from_dict(obj["id"]) if obj.get("id") is not None else None,
            "name": obj.get("name")
        })
        return _obj
