...
class V0042Node(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "boot_time": V0042Uint64NoValStruct.from_dict(obj["boot_time"]) if obj.get("boot_time") is not None else None,
            ...
            "free_mem": V0042Uint64NoValStruct.from_dict(obj["free_mem"]) if obj.get("free_mem") is not None else None,
            "cpus": obj.get("cpus"),
            "effective_cpus": obj.get("effective_cpus"),
            "specialized_cpus": obj.get("specialized_cpus"),
            "energy": V0042AcctGatherEnergy.from_dict(obj["energy"]) if obj.get("energy") is not None else None,
            ...
            "last_busy": V0042Uint64NoValStruct.from_dict(obj["last_busy"]) if obj.get("last_busy") is not None else None,
            ...
            "reason_changed_at": V0042Uint64NoValStruct.from_dict(obj["reason_changed_at"]) if obj.get("reason_changed_at") is not None else None,
            "reason_set_by_user": obj.get("reason_set_by_user"),
            "resume_after": V0042Uint64NoValStruct.from_dict(obj["resume_after"]) if obj.get("resume_after") is not None else None,
            ...
            "slurmd_start_time": V0042Uint64NoValStruct.from_dict(obj["slurmd_start_time"]) if obj.get("slurmd_start_time") is not None else None,
