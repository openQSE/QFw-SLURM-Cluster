...
class V0043RollupStatsHourly(BaseModel):
    """
    V0043RollupStatsHourly
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="Number of hourly rollups since last_run")
    last_run: Optional[StrictInt] = Field(default=None, description="Last time hourly rollup ran (UNIX timestamp) (UNIX timestamp or time string recognized by Slurm (e.g., '[MM/DD[/YY]-]HH:MM[:SS]'))")
    duration: Optional[V0042RollupStatsHourlyDuration] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "duration": V0042RollupStatsHourlyDuration.from_dict(obj["duration"]) if obj.get("duration") is not None else None
        })
        return _obj
