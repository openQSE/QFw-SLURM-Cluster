...
class V0043QosLimitsMaxTresMinutes(BaseModel):
    """
    V0043QosLimitsMaxTresMinutes
    """ # noqa: E501
    total: Optional[List[V0043Tres]] = None
    per: Optional[V0043QosLimitsMaxTresMinutesPer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "per": V0043QosLimitsMaxTresMinutesPer.from_dict(obj["per"]) if obj.get("per") is not None else None
        })
        return _obj
