...
class V0042OpenapiAccountsAddCondResp(BaseModel):
    """
    V0042OpenapiAccountsAddCondResp
    """ # noqa: E501
    association_condition: Optional[V0042AccountsAddCond] = None
    account: Optional[V0042AccountShort] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "association_condition": V0042AccountsAddCond.from_dict(obj["association_condition"]) if obj.get("association_condition") is not None else None,
            "account": V0042AccountShort.from_dict(obj["account"]) if obj.get("account") is not None else None,
