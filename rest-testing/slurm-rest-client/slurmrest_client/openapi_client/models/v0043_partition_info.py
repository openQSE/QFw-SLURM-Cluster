...
class V0043PartitionInfo(BaseModel):
    """
    V0043PartitionInfo
    """ # noqa: E501
    nodes: Optional[V0043PartitionInfoNodes] = None
    accounts: Optional[V0043PartitionInfoAccounts] = None
    groups: Optional[V0043PartitionInfoGroups] = None
    qos: Optional[V0043PartitionInfoQos] = None
    alternate: Optional[StrictStr] = Field(default=None, description="Alternate - Partition name of alternate partition to be used if the state of this partition is DRAIN or INACTIVE")
    tres: Optional[V0043PartitionInfoTres] = None
    ...
    cpus: Optional[V0043PartitionInfoCpus] = None
    defaults: Optional[V0043PartitionInfoDefaults] = None
    grace_time: Optional[StrictInt] = Field(default=None, description="GraceTime - Grace time in seconds to be extended to a job which has been selected for preemption")
    maximums: Optional[V0043PartitionInfoMaximums] = None
    minimums: Optional[V0043PartitionInfoMinimums] = None
    name: Optional[StrictStr] = Field(default=None, description="PartitionName - Name by which the partition may be referenced")
    node_sets: Optional[StrictStr] = Field(default=None, description="NodeSets - Comma-separated list of nodesets which are associated with this partition")
    priority: Optional[V0043PartitionInfoPriority] = None
    timeouts: Optional[V0043PartitionInfoTimeouts] = None
    topology: Optional[StrictStr] = Field(default=None, description="Topology - Name of the topology, defined in topology.yaml, used by jobs in this partition")
    partition: Optional[V0041OpenapiPartitionRespPartitionsInnerPartition] = None
    suspend_time: Optional[V0043Uint32NoValStruct] = None
    __properties: ClassVar[List[str]] = ["nodes", "accounts", "groups", "qos", "alternate", "tres", "cluster", "select_type", "cpus", "defaults", "grace_time", "maximums", "minimums", "name", "node_sets", "priority", "timeouts", "topology", "partition", "suspend_time"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nodes": V0043PartitionInfoNodes.from_dict(obj["nodes"]) if obj.get("nodes") is not None else None,
            "accounts": V0043PartitionInfoAccounts.from_dict(obj["accounts"]) if obj.get("accounts") is not None else None,
            "groups": V0043PartitionInfoGroups.from_dict(obj["groups"]) if obj.get("groups") is not None else None,
            "qos": V0043PartitionInfoQos.from_dict(obj["qos"]) if obj.get("qos") is not None else None,
            "alternate": obj.get("alternate"),
            "tres": V0043PartitionInfoTres.from_dict(obj["tres"]) if obj.get("tres") is not None else None,
            "cluster": obj.get("cluster"),
            "select_type": obj.get("select_type"),
            "cpus": V0043PartitionInfoCpus.from_dict(obj["cpus"]) if obj.get("cpus") is not None else None,
            "defaults": V0043PartitionInfoDefaults.from_dict(obj["defaults"]) if obj.get("defaults") is not None else None,
            "grace_time": obj.get("grace_time"),
            "maximums": V0043PartitionInfoMaximums.from_dict(obj["maximums"]) if obj.get("maximums") is not None else None,
            "minimums": V0043PartitionInfoMinimums.from_dict(obj["minimums"]) if obj.get("minimums") is not None else None,
            "name": obj.get("name"),
            "node_sets": obj.get("node_sets"),
            "priority": V0043PartitionInfoPriority.from_dict(obj["priority"]) if obj.get("priority") is not None else None,
            "timeouts": V0043PartitionInfoTimeouts.from_dict(obj["timeouts"]) if obj.get("timeouts") is not None else None,
            ...
            "suspend_time": V0043Uint32NoValStruct.from_dict(obj["suspend_time"]) if obj.get("suspend_time") is not None else None
        })
        return _obj
