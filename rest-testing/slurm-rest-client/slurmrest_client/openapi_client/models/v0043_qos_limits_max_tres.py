...
class V0043QosLimitsMaxTres(BaseModel):
    """
    V0043QosLimitsMaxTres
    """ # noqa: E501
    total: Optional[List[V0043Tres]] = None
    minutes: Optional[V0043QosLimitsMaxTresMinutes] = None
    per: Optional[V0043QosLimitsMaxTresPer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "minutes": V0043QosLimitsMaxTresMinutes.from_dict(obj["minutes"]) if obj.get("minutes") is not None else None,
            "per": V0043QosLimitsMaxTresPer.from_dict(obj["per"]) if obj.get("per") is not None else None
        })
        return _obj
