...
class V0042OpenapiNodesResp(BaseModel):
    """
    V0042OpenapiNodesResp
    """ # noqa: E501
    nodes: List[V0042Node]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nodes": [V0042Node.from_dict(_item) for _item in obj["nodes"]] if obj.get("nodes") is not None else None,
