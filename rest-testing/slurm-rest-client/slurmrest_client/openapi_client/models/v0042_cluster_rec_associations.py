...
class V0042ClusterRecAssociations(BaseModel):
    """
    V0042ClusterRecAssociations
    """ # noqa: E501
    root: Optional[V0042AssocShort] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "root": V0042AssocShort.from_dict(obj["root"]) if obj.get("root") is not None else None
        })
        return _obj
