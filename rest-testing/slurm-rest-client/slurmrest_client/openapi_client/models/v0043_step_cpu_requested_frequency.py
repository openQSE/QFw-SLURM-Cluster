...
class V0043StepCPURequestedFrequency(BaseModel):
    """
    V0043StepCPURequestedFrequency
    """ # noqa: E501
    min: Optional[V0043Uint32NoValStruct] = None
    max: Optional[V0043Uint32NoValStruct] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "min": V0043Uint32NoValStruct.from_dict(obj["min"]) if obj.get("min") is not None else None,
            "max": V0043Uint32NoValStruct.from_dict(obj["max"]) if obj.get("max") is not None else None
        })
        return _obj
