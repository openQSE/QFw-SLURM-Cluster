...
class V0042JobTime(BaseModel):
    ...
    planned: Optional[V0042Uint64NoValStruct] = None
    ...
    limit: Optional[V0042Uint32NoValStruct] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "end": obj.get("end"),
            "planned": V0042Uint64NoValStruct.from_dict(obj["planned"]) if obj.get("planned") is not None else None,
            "start": obj.get("start"),
            ...
            "limit": V0042Uint32NoValStruct.from_dict(obj["limit"]) if obj.get("limit") is not None else None,
