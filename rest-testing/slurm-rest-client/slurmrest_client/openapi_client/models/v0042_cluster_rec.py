...
class V0042ClusterRec(BaseModel):
    """
    V0042ClusterRec
    """ # noqa: E501
    controller: Optional[V0042ClusterRecController] = None
    ...
    associations: Optional[V0042ClusterRecAssociations] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "controller": V0042ClusterRecController.from_dict(obj["controller"]) if obj.get("controller") is not None else None,
            "flags": obj.get("flags"),
            "name": obj.get("name"),
            "nodes": obj.get("nodes"),
            "select_plugin": obj.get("select_plugin"),
            "associations": V0042ClusterRecAssociations.from_dict(obj["associations"]) if obj.get("associations") is not None else None,
