...
class V0040AssocMax(BaseModel):
    """
    V0040AssocMax
    """ # noqa: E501
    jobs: Optional[V0040AssocMaxJobs] = None
    tres: Optional[V0040AssocMaxTres] = None
    per: Optional[V0040AssocMaxPer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jobs": V0040AssocMaxJobs.from_dict(obj["jobs"]) if obj.get("jobs") is not None else None,
            "tres": V0040AssocMaxTres.from_dict(obj["tres"]) if obj.get("tres") is not None else None,
            "per": V0040AssocMaxPer.from_dict(obj["per"]) if obj.get("per") is not None else None
        })
        return _obj
