...
class V0043Wckey(BaseModel):
    """
    V0043Wckey
    """ # noqa: E501
    accounting: Optional[List[V0043Accounting]] = None
    cluster: StrictStr = Field(description="Cluster name")
    id: Optional[StrictInt] = Field(default=None, description="Unique ID for this user-cluster-wckey combination")
    name: StrictStr = Field(description="WCKey name")
    user: StrictStr = Field(description="User name")
    flags: Optional[List[StrictStr]] = Field(default=None, description="Flags associated with this WCKey")
