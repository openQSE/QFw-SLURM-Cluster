...
class V0043ReservationDescMsg(BaseModel):
    """
    ...
    core_count: Optional[V0043Uint32NoValStruct] = None
    duration: Optional[V0043Uint32NoValStruct] = None
    ...
    max_start_delay: Optional[V0043Uint32NoValStruct] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "core_count": V0043Uint32NoValStruct.from_dict(obj["core_count"]) if obj.get("core_count") is not None else None,
            "duration": V0043Uint32NoValStruct.from_dict(obj["duration"]) if obj.get("duration") is not None else None,
            ...
            "max_start_delay": V0043Uint32NoValStruct.from_dict(obj["max_start_delay"]) if obj.get("max_start_delay") is not None else None,
            "name": obj.get("name"),
