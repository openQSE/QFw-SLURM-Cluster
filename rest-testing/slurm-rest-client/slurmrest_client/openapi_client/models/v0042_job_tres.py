...
class V0042JobTres(BaseModel):
    """
    V0042JobTres
    """ # noqa: E501
    allocated: Optional[List[V0042Tres]] = None
    requested: Optional[List[V0042Tres]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "requested": [V0042Tres.from_dict(_item) for _item in obj["requested"]] if obj.get("requested") is not None else None
        })
        return _obj
