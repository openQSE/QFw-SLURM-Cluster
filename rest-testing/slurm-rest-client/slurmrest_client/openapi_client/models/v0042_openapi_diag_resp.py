...
class V0042OpenapiDiagResp(BaseModel):
    """
    V0042OpenapiDiagResp
    """ # noqa: E501
    statistics: V0042StatsMsg
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "statistics": V0042StatsMsg.from_dict(obj["statistics"]) if obj.get("statistics") is not None else None,
