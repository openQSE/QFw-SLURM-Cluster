...
class V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerStatisticsEnergy(BaseModel):
    """
    V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerStatisticsEnergy
    """ # noqa: E501
    consumed: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerStatisticsEnergyConsumed] = None
    __properties: ClassVar[List[str]] = ["consumed"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "consumed": V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerStatisticsEnergyConsumed.from_dict(obj["consumed"]) if obj.get("consumed") is not None else None
        })
        return _obj
