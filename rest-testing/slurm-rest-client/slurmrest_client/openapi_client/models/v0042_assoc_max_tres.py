...
class V0042AssocMaxTres(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "group": V0042AssocMaxTresGroup.from_dict(obj["group"]) if obj.get("group") is not None else None,
            "minutes": V0042AssocMaxTresMinutes.from_dict(obj["minutes"]) if obj.get("minutes") is not None else None,
            "per": V0042AssocMaxTresPer.from_dict(obj["per"]) if obj.get("per") is not None else None
        })
        return _obj
