...
class V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxTresMinutes(BaseModel):
    ...
    """ # noqa: E501
    total: Optional[List[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequestedMaxInner]] = Field(default=None, description="MaxTRESMinsPerJob")
    per: Optional[V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxTresMinutesPer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "per": V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxTresMinutesPer.from_dict(obj["per"]) if obj.get("per") is not None else None
        })
        return _obj
