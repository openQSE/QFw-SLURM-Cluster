...
class V0042AssocMaxJobsPer(BaseModel):
    """
    V0042AssocMaxJobsPer
    """ # noqa: E501
    count: Optional[V0042Uint32NoValStruct] = None
    accruing: Optional[V0042Uint32NoValStruct] = None
    submitted: Optional[V0042Uint32NoValStruct] = None
    wall_clock: Optional[V0042Uint32NoValStruct] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "submitted": V0042Uint32NoValStruct.from_dict(obj["submitted"]) if obj.get("submitted") is not None else None,
            "wall_clock": V0042Uint32NoValStruct.from_dict(obj["wall_clock"]) if obj.get("wall_clock") is not None else None
        })
        return _obj
