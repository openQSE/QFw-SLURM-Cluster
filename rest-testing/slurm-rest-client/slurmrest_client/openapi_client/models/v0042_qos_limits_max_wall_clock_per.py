...
class V0042QosLimitsMaxWallClockPer(BaseModel):
    """
    V0042QosLimitsMaxWallClockPer
    """ # noqa: E501
    qos: Optional[V0042Uint32NoValStruct] = None
    job: Optional[V0042Uint32NoValStruct] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "qos": V0042Uint32NoValStruct.from_dict(obj["qos"]) if obj.get("qos") is not None else None,
            "job": V0042Uint32NoValStruct.from_dict(obj["job"]) if obj.get("job") is not None else None
        })
        return _obj
