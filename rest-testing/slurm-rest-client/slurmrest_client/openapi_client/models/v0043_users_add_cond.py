...
class V0043UsersAddCond(BaseModel):
    """
    V0043UsersAddCond
    """ # noqa: E501
    accounts: Optional[List[StrictStr]] = None
    association: Optional[V0043AssocRecSet] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "association": V0043AssocRecSet.from_dict(obj["association"]) if obj.get("association") is not None else None,
