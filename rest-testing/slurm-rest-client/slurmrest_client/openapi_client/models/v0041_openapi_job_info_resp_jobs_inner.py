...
class V0041OpenapiJobInfoRespJobsInner(BaseModel):
    ...
    memory_per_cpu: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu] = None
    memory_per_node: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerNode] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "array_task_id": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["array_task_id"]) if obj.get("array_task_id") is not None else None,
            ...
            "het_job_offset": V0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset.from_dict(obj["het_job_offset"]) if obj.get("het_job_offset") is not None else None,
            ...
            "memory_per_cpu": V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu.from_dict(obj["memory_per_cpu"]) if obj.get("memory_per_cpu") is not None else None,
            "memory_per_node": V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerNode.from_dict(obj["memory_per_node"]) if obj.get("memory_per_node") is not None else None,
            ...
            "time_limit": V0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit.from_dict(obj["time_limit"]) if obj.get("time_limit") is not None else None,
