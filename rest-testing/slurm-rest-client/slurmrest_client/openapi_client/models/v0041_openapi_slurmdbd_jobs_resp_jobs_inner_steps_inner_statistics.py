...
class V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerStatistics(BaseModel):
    """
    ...
    energy: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerStatisticsEnergy] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "energy": V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerStatisticsEnergy.from_dict(obj["energy"]) if obj.get("energy") is not None else None
        })
        return _obj
