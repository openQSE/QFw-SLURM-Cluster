...
class V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxAccruingPer(BaseModel):
    """
    V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxAccruingPer
    """ # noqa: E501
    account: Optional[V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxAccruingPerAccount] = None
    user: Optional[V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxAccruingPerUser] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "account": V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxAccruingPerAccount.from_dict(obj["account"]) if obj.get("account") is not None else None,
            "user": V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxAccruingPerUser.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
