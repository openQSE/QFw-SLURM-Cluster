...
class V0043QosLimits(BaseModel):
    """
    V0043QosLimits
    """ # noqa: E501
    grace_time: Optional[StrictInt] = Field(default=None, description="GraceTime - Preemption grace time in seconds to be extended to a job which has been selected for preemption")
    max: Optional[V0043QosLimitsMax] = None
    factor: Optional[V0043Float64NoValStruct] = None
    min: Optional[V0043QosLimitsMin] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "max": V0043QosLimitsMax.from_dict(obj["max"]) if obj.get("max") is not None else None,
            "factor": V0043Float64NoValStruct.from_dict(obj["factor"]) if obj.get("factor") is not None else None,
            "min": V0043QosLimitsMin.from_dict(obj["min"]) if obj.get("min") is not None else None
        })
        return _obj
