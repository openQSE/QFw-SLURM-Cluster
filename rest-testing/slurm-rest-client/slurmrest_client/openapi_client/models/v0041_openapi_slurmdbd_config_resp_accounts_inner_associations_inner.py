...
class V0041OpenapiSlurmdbdConfigRespAccountsInnerAssociationsInner(BaseModel):
    """
    ...
    cluster: Optional[StrictStr] = Field(default=None, description="Cluster")
    partition: Optional[StrictStr] = Field(default=None, description="Partition")
    user: StrictStr = Field(description="User name")
    id: Optional[StrictInt] = Field(default=None, description="Numeric association ID")
    __properties: ClassVar[List[str]] = ["account", "cluster", "partition", "user", "id"]
