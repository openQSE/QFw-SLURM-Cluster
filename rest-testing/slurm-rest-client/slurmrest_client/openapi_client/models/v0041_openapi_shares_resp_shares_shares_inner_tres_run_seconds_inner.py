...
class V0041OpenapiSharesRespSharesSharesInnerTresRunSecondsInner(BaseModel):
    """
    V0041OpenapiSharesRespSharesSharesInnerTresRunSecondsInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="TRES name")
    value: Optional[V0041OpenapiSharesRespSharesSharesInnerTresRunSecondsInnerValue] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "value": V0041OpenapiSharesRespSharesSharesInnerTresRunSecondsInnerValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
