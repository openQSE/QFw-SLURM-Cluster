...
class V0042JobResSocket(BaseModel):
    """
    V0042JobResSocket
    """ # noqa: E501
    index: StrictInt = Field(description="Core index")
    cores: List[V0042JobResCore]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "index": obj.get("index"),
            "cores": [V0042JobResCore.from_dict(_item) for _item in obj["cores"]] if obj.get("cores") is not None else None
        })
        return _obj
