...
class V0042AssocMaxTresMinutes(BaseModel):
    """
    V0042AssocMaxTresMinutes
    """ # noqa: E501
    total: Optional[List[V0042Tres]] = None
    per: Optional[V0042QosLimitsMinTresPer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "per": V0042QosLimitsMinTresPer.from_dict(obj["per"]) if obj.get("per") is not None else None
        })
        return _obj
