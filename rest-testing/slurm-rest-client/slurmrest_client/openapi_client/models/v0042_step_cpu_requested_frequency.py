...
class V0042StepCPURequestedFrequency(BaseModel):
    """
    V0042StepCPURequestedFrequency
    """ # noqa: E501
    min: Optional[V0042Uint32NoValStruct] = None
    max: Optional[V0042Uint32NoValStruct] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "min": V0042Uint32NoValStruct.from_dict(obj["min"]) if obj.get("min") is not None else None,
            "max": V0042Uint32NoValStruct.from_dict(obj["max"]) if obj.get("max") is not None else None
        })
        return _obj
