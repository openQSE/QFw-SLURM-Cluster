...
class V0042QosLimitsMaxWallClock(BaseModel):
    """
    V0042QosLimitsMaxWallClock
    """ # noqa: E501
    per: Optional[V0042QosLimitsMaxWallClockPer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "per": V0042QosLimitsMaxWallClockPer.from_dict(obj["per"]) if obj.get("per") is not None else None
        })
        return _obj
