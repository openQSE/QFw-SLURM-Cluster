...
class V0041OpenapiPartitionRespPartitionsInnerTimeouts(BaseModel):
    """
    V0041OpenapiPartitionRespPartitionsInnerTimeouts
    """ # noqa: E501
    resume: Optional[V0041OpenapiPartitionRespPartitionsInnerTimeoutsResume] = None
    suspend: Optional[V0041OpenapiPartitionRespPartitionsInnerTimeoutsSuspend] = None
    __properties: ClassVar[List[str]] = ["resume", "suspend"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resume": V0041OpenapiPartitionRespPartitionsInnerTimeoutsResume.from_dict(obj["resume"]) if obj.get("resume") is not None else None,
            "suspend": V0041OpenapiPartitionRespPartitionsInnerTimeoutsSuspend.from_dict(obj["suspend"]) if obj.get("suspend") is not None else None
        })
        return _obj
