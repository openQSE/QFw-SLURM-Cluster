...
class V0040SharesRespMsg(BaseModel):
    """
    V0040SharesRespMsg
    """ # noqa: E501
    shares: Optional[List[V0040AssocSharesObjWrap]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "shares": [V0040AssocSharesObjWrap.from_dict(_item) for _item in obj["shares"]] if obj.get("shares") is not None else None,
