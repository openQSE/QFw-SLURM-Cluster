...
class V0041OpenapiSlurmdbdConfigRespUsersInnerWckeysInner(BaseModel):
    """
    ...
    flags: Optional[List[StrictStr]] = Field(default=None, description="Flags associated with the WCKey")
