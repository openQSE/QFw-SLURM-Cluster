...
class V0042StepStatistics(BaseModel):
    """
    V0042StepStatistics
    """ # noqa: E501
    cpu: Optional[V0042StepStatisticsCPU] = Field(default=None, alias="CPU")
    energy: Optional[V0042StepStatisticsEnergy] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "energy": V0042StepStatisticsEnergy.from_dict(obj["energy"]) if obj.get("energy") is not None else None
        })
        return _obj
