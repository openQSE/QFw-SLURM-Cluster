...
class V0040OpenapiAccountsAddCondResp(BaseModel):
    """
    V0040OpenapiAccountsAddCondResp
    """ # noqa: E501
    association_condition: Optional[V0040AccountsAddCond] = None
    account: Optional[V0040AccountShort] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "association_condition": V0040AccountsAddCond.from_dict(obj["association_condition"]) if obj.get("association_condition") is not None else None,
            "account": V0040AccountShort.from_dict(obj["account"]) if obj.get("account") is not None else None,
