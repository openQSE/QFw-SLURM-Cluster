...
class V0042OpenapiUsersAddCondResp(BaseModel):
    """
    V0042OpenapiUsersAddCondResp
    """ # noqa: E501
    association_condition: V0042UsersAddCond
    user: V0042UserShort
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "association_condition": V0042UsersAddCond.from_dict(obj["association_condition"]) if obj.get("association_condition") is not None else None,
            "user": V0042UserShort.from_dict(obj["user"]) if obj.get("user") is not None else None,
