...
class V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxTres(BaseModel):
    ...
    """ # noqa: E501
    total: Optional[List[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequestedMaxInner]] = Field(default=None, description="GrpTRES")
    group: Optional[V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxTresGroup] = None
    minutes: Optional[V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxTresMinutes] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "group": V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxTresGroup.from_dict(obj["group"]) if obj.get("group") is not None else None,
            "minutes": V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxTresMinutes.from_dict(obj["minutes"]) if obj.get("minutes") is not None else None,
            "per": V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxTresPer.from_dict(obj["per"]) if obj.get("per") is not None else None
        })
        return _obj
