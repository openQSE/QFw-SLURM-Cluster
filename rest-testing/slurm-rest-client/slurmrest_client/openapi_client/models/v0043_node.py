...
class V0043Node(BaseModel):
    ...
    boot_time: Optional[V0043Uint64NoValStruct] = None
    tls_cert_last_renewal: Optional[V0043Uint64NoValStruct] = None
    cert_flags: Optional[List[StrictStr]] = Field(default=None, description="Certmgr status flags")
    ...
    free_mem: Optional[V0043Uint64NoValStruct] = None
    ...
    energy: Optional[V0043AcctGatherEnergy] = None
    ...
    last_busy: Optional[V0043Uint64NoValStruct] = None
    ...
    reason_changed_at: Optional[V0043Uint64NoValStruct] = None
    reason_set_by_user: Optional[StrictStr] = Field(default=None, description="User who set the reason")
    resume_after: Optional[V0043Uint64NoValStruct] = None
    ...
    tres_weighted: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Ignored. Was weighted number of billable trackable resources allocated")
    slurmd_start_time: Optional[V0043Uint64NoValStruct] = None
    ...
    topology: Optional[StrictStr] = Field(default=None, description="Topology")
    ...
    __properties: ClassVar[List[str]] = ["architecture", "burstbuffer_network_address", "boards", "boot_time", "tls_cert_last_renewal", "cert_flags", "cluster_name", "cores", "specialized_cores", "cpu_binding", "cpu_load", "free_mem", "cpus", "effective_cpus", "specialized_cpus", "energy", "external_sensors", "extra", "power", "features", "active_features", "gpu_spec", "gres", "gres_drained", "gres_used", "instance_id", "instance_type", "last_busy", "mcs_label", "specialized_memory", "name", "next_state_after_reboot", "address", "hostname", "state", "operating_system", "owner", "partitions", "port", "real_memory", "res_cores_per_gpu", "comment", "reason", "reason_changed_at", "reason_set_by_user", "resume_after", "reservation", "alloc_memory", "alloc_cpus", "alloc_idle_cpus", "tres_used", "tres_weighted", "slurmd_start_time", "sockets", "threads", "temporary_disk", "weight", "topology", "tres", "version"]

    @field_validator('cert_flags')
    def cert_flags_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        for i in value:
            if i not in set(['TOKEN_SET']):
                raise ValueError("each list item must be one of ('TOKEN_SET')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of tls_cert_last_renewal
        if self.tls_cert_last_renewal:
            _dict['tls_cert_last_renewal'] = self.tls_cert_last_renewal.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "boot_time": V0043Uint64NoValStruct.from_dict(obj["boot_time"]) if obj.get("boot_time") is not None else None,
            "tls_cert_last_renewal": V0043Uint64NoValStruct.from_dict(obj["tls_cert_last_renewal"]) if obj.get("tls_cert_last_renewal") is not None else None,
            "cert_flags": obj.get("cert_flags"),
            ...
            "free_mem": V0043Uint64NoValStruct.from_dict(obj["free_mem"]) if obj.get("free_mem") is not None else None,
            "cpus": obj.get("cpus"),
            "effective_cpus": obj.get("effective_cpus"),
            "specialized_cpus": obj.get("specialized_cpus"),
            "energy": V0043AcctGatherEnergy.from_dict(obj["energy"]) if obj.get("energy") is not None else None,
            ...
            "last_busy": V0043Uint64NoValStruct.from_dict(obj["last_busy"]) if obj.get("last_busy") is not None else None,
            ...
            "reason_changed_at": V0043Uint64NoValStruct.from_dict(obj["reason_changed_at"]) if obj.get("reason_changed_at") is not None else None,
            "reason_set_by_user": obj.get("reason_set_by_user"),
            "resume_after": V0043Uint64NoValStruct.from_dict(obj["resume_after"]) if obj.get("resume_after") is not None else None,
            ...
            "slurmd_start_time": V0043Uint64NoValStruct.from_dict(obj["slurmd_start_time"]) if obj.get("slurmd_start_time") is not None else None,
