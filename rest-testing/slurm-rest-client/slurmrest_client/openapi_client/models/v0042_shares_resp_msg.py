...
class V0042SharesRespMsg(BaseModel):
    """
    V0042SharesRespMsg
    """ # noqa: E501
    shares: Optional[List[V0042AssocSharesObjWrap]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "shares": [V0042AssocSharesObjWrap.from_dict(_item) for _item in obj["shares"]] if obj.get("shares") is not None else None,
