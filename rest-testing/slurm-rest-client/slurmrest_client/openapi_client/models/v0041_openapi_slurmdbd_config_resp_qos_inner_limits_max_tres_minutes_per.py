...
class V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxTresMinutesPer(BaseModel):
    ...
    """ # noqa: E501
    qos: Optional[List[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequestedMaxInner]] = Field(default=None, description="GrpTRESRunMins")
    job: Optional[List[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequestedMaxInner]] = Field(default=None, description="MaxTRESMinsPerJob")
    account: Optional[List[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequestedMaxInner]] = Field(default=None, description="MaxTRESRunMinsPerAccount")
    user: Optional[List[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequestedMaxInner]] = Field(default=None, description="MaxTRESRunMinsPerUser")
