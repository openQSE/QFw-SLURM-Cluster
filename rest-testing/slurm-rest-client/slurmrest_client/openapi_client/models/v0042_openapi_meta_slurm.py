...
class V0042OpenapiMetaSlurm(BaseModel):
    ...
    release: Optional[StrictStr] = Field(default=None, description="Slurm release string")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "version": V0042OpenapiMetaSlurmVersion.from_dict(obj["version"]) if obj.get("version") is not None else None,
