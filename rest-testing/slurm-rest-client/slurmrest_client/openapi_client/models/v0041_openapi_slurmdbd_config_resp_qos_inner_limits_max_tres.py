...
class V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxTres(BaseModel):
    """
    ...
    minutes: Optional[V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxTresMinutes] = None
    per: Optional[V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxTresPer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "minutes": V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxTresMinutes.from_dict(obj["minutes"]) if obj.get("minutes") is not None else None,
            "per": V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxTresPer.from_dict(obj["per"]) if obj.get("per") is not None else None
        })
        return _obj
