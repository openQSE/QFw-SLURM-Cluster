...
class V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxAccruing(BaseModel):
    """
    V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxAccruing
    """ # noqa: E501
    per: Optional[V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxAccruingPer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "per": V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxAccruingPer.from_dict(obj["per"]) if obj.get("per") is not None else None
        })
        return _obj
