...
class V0043JobAllocReq(BaseModel):
    """
    V0043JobAllocReq
    """ # noqa: E501
    hetjob: Optional[List[V0043JobDescMsg]] = None
    job: Optional[V0043JobDescMsg] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hetjob": [V0043JobDescMsg.from_dict(_item) for _item in obj["hetjob"]] if obj.get("hetjob") is not None else None,
            "job": V0043JobDescMsg.from_dict(obj["job"]) if obj.get("job") is not None else None
        })
        return _obj
