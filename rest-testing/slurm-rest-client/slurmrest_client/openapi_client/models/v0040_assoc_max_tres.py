...
class V0040AssocMaxTres(BaseModel):
    """
    V0040AssocMaxTres
    """ # noqa: E501
    total: Optional[List[V0040Tres]] = None
    group: Optional[V0040AssocMaxTresGroup] = None
    minutes: Optional[V0040AssocMaxTresMinutes] = None
    per: Optional[V0040AssocMaxTresPer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "total": [V0040Tres.from_dict(_item) for _item in obj["total"]] if obj.get("total") is not None else None,
            "group": V0040AssocMaxTresGroup.from_dict(obj["group"]) if obj.get("group") is not None else None,
            "minutes": V0040AssocMaxTresMinutes.from_dict(obj["minutes"]) if obj.get("minutes") is not None else None,
            "per": V0040AssocMaxTresPer.from_dict(obj["per"]) if obj.get("per") is not None else None
        })
        return _obj
