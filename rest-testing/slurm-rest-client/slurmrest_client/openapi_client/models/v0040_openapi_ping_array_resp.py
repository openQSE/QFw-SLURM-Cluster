...
class V0040OpenapiPingArrayResp(BaseModel):
    """
    V0040OpenapiPingArrayResp
    """ # noqa: E501
    pings: List[V0040ControllerPing]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pings": [V0040ControllerPing.from_dict(_item) for _item in obj["pings"]] if obj.get("pings") is not None else None,
