...
class V0041OpenapiSlurmdbdJobsRespJobsInnerHet(BaseModel):
    """
    V0041OpenapiSlurmdbdJobsRespJobsInnerHet
    """ # noqa: E501
    job_id: Optional[StrictInt] = Field(default=None, description="Heterogeneous job ID, if applicable")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of job_offset
        if self.job_offset:
            _dict['job_offset'] = self.job_offset.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "job_offset": V0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset.from_dict(obj["job_offset"]) if obj.get("job_offset") is not None else None
        })
        return _obj
