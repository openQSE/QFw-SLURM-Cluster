...
class V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMinTresPer(BaseModel):
    """
    V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMinTresPer
    """ # noqa: E501
    job: Optional[List[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequestedMaxInner]] = Field(default=None, description="MinTRES")
