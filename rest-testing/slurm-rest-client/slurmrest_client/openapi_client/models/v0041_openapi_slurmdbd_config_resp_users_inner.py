...
class V0041OpenapiSlurmdbdConfigRespUsersInner(BaseModel):
    ...
    associations: Optional[List[V0041OpenapiSlurmdbdConfigRespAccountsInnerAssociationsInner]] = Field(default=None, description="Associations created for this user")
    coordinators: Optional[List[V0041OpenapiSlurmdbdConfigRespAccountsInnerCoordinatorsInner]] = Field(default=None, description="Accounts this user is a coordinator for")
    ...
    wckeys: Optional[List[V0041OpenapiSlurmdbdConfigRespUsersInnerWckeysInner]] = Field(default=None, description="List of available WCKeys")
