...
class V0042OpenapiSlurmdbdPingResp(BaseModel):
    """
    V0042OpenapiSlurmdbdPingResp
    """ # noqa: E501
    pings: List[V0042SlurmdbdPing]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pings": [V0042SlurmdbdPing.from_dict(_item) for _item in obj["pings"]] if obj.get("pings") is not None else None,
