...
class V0040QosLimitsMaxTresMinutesPer(BaseModel):
    """
    V0040QosLimitsMaxTresMinutesPer
    """ # noqa: E501
    qos: Optional[List[V0040Tres]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "qos": [V0040Tres.from_dict(_item) for _item in obj["qos"]] if obj.get("qos") is not None else None,
