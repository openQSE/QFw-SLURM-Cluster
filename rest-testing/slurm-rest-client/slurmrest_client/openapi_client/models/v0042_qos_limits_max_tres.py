...
class V0042QosLimitsMaxTres(BaseModel):
    """
    V0042QosLimitsMaxTres
    """ # noqa: E501
    total: Optional[List[V0042Tres]] = None
    minutes: Optional[V0042QosLimitsMaxTresMinutes] = None
    per: Optional[V0042QosLimitsMaxTresPer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "minutes": V0042QosLimitsMaxTresMinutes.from_dict(obj["minutes"]) if obj.get("minutes") is not None else None,
            "per": V0042QosLimitsMaxTresPer.from_dict(obj["per"]) if obj.get("per") is not None else None
        })
        return _obj
