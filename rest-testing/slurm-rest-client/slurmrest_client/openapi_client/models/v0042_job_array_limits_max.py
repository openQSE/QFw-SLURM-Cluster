...
class V0042JobArrayLimitsMax(BaseModel):
    """
    V0042JobArrayLimitsMax
    """ # noqa: E501
    running: Optional[V0042JobArrayLimitsMaxRunning] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "running": V0042JobArrayLimitsMaxRunning.from_dict(obj["running"]) if obj.get("running") is not None else None
        })
        return _obj
