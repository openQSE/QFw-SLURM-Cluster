...
class V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTres(BaseModel):
    ...
    """ # noqa: E501
    requested: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequested] = None
    consumed: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresConsumed] = None
    allocated: Optional[List[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequestedMaxInner]] = Field(default=None, description="Trackable resources allocated to the step")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requested": V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequested.from_dict(obj["requested"]) if obj.get("requested") is not None else None,
            "consumed": V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresConsumed.from_dict(obj["consumed"]) if obj.get("consumed") is not None else None,
