...
class V0043RollupStatsMonthly(BaseModel):
    """
    V0043RollupStatsMonthly
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="Number of monthly rollups since last_run")
    last_run: Optional[StrictInt] = Field(default=None, description="Last time monthly rollup ran (UNIX timestamp) (UNIX timestamp or time string recognized by Slurm (e.g., '[MM/DD[/YY]-]HH:MM[:SS]'))")
