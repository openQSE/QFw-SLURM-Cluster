...
class V0043Job(BaseModel):
    ...
    time: Optional[V0043JobTime] = None
    ...
    flags: Optional[List[StrictStr]] = Field(default=None, description="Flags associated with this job")
    group: Optional[StrictStr] = Field(default=None, description="Group ID of the user that owns the job")
    het: Optional[V0043JobHet] = None
    ...
    required: Optional[V0043JobRequired] = None
    ...
    reservation: Optional[V0043JobReservation] = None
    ...
    wckey: Optional[V0043WckeyTagStruct] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "comment": V0042JobComment.from_dict(obj["comment"]) if obj.get("comment") is not None else None,
            "allocation_nodes": obj.get("allocation_nodes"),
            "array": V0043JobArray.from_dict(obj["array"]) if obj.get("array") is not None else None,
            "association": V0043AssocShort.from_dict(obj["association"]) if obj.get("association") is not None else None,
            "block": obj.get("block"),
            ...
            "time": V0043JobTime.from_dict(obj["time"]) if obj.get("time") is not None else None,
            ...
            "flags": obj.get("flags"),
            "group": obj.get("group"),
            "het": V0043JobHet.from_dict(obj["het"]) if obj.get("het") is not None else None,
            "job_id": obj.get("job_id"),
            "name": obj.get("name"),
            "licenses": obj.get("licenses"),
            "mcs": V0042JobMcs.from_dict(obj["mcs"]) if obj.get("mcs") is not None else None,
            "nodes": obj.get("nodes"),
            ...
            "required": V0043JobRequired.from_dict(obj["required"]) if obj.get("required") is not None else None,
            "kill_request_user": obj.get("kill_request_user"),
            "restart_cnt": obj.get("restart_cnt"),
            "reservation": V0043JobReservation.from_dict(obj["reservation"]) if obj.get("reservation") is not None else None,
            ...
            "stdin": obj.get("stdin"),
            "state": V0041OpenapiSlurmdbdJobsRespJobsInnerState.from_dict(obj["state"]) if obj.get("state") is not None else None,
            "steps": [V0043Step.from_dict(_item) for _item in obj["steps"]] if obj.get("steps") is not None else None,
            "submit_line": obj.get("submit_line"),
            "tres": V0043JobTres.from_dict(obj["tres"]) if obj.get("tres") is not None else None,
            "used_gres": obj.get("used_gres"),
            "user": obj.get("user"),
            "wckey": V0043WckeyTagStruct.from_dict(obj["wckey"]) if obj.get("wckey") is not None else None,
