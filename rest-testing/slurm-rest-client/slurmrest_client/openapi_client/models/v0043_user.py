...
class V0043User(BaseModel):
    ...
    flags: Optional[List[StrictStr]] = Field(default=None, description="Flags associated with this user")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "default": V0042UserDefault.from_dict(obj["default"]) if obj.get("default") is not None else None,
            "flags": obj.get("flags"),
            "name": obj.get("name"),
