...
class V0043JobResNode(BaseModel):
    """
    V0043JobResNode
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "index": obj.get("index"),
            "name": obj.get("name"),
            "cpus": V0042JobResNodeCpus.from_dict(obj["cpus"]) if obj.get("cpus") is not None else None,
            "memory": V0042JobResNodeMemory.from_dict(obj["memory"]) if obj.get("memory") is not None else None,
            "sockets": [V0043JobResSocket.from_dict(_item) for _item in obj["sockets"]] if obj.get("sockets") is not None else None
        })
        return _obj
