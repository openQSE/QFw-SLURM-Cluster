...
class V0043StepStatistics(BaseModel):
    """
    V0043StepStatistics
    """ # noqa: E501
    cpu: Optional[V0042StepStatisticsCPU] = Field(default=None, alias="CPU")
    energy: Optional[V0043StepStatisticsEnergy] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "energy": V0043StepStatisticsEnergy.from_dict(obj["energy"]) if obj.get("energy") is not None else None
        })
        return _obj
