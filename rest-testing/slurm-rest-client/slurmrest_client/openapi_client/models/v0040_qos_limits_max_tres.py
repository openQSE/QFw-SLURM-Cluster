...
class V0040QosLimitsMaxTres(BaseModel):
    """
    V0040QosLimitsMaxTres
    """ # noqa: E501
    total: Optional[List[V0040Tres]] = None
    minutes: Optional[V0040QosLimitsMaxTresMinutes] = None
    per: Optional[V0040QosLimitsMaxTresPer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "minutes": V0040QosLimitsMaxTresMinutes.from_dict(obj["minutes"]) if obj.get("minutes") is not None else None,
            "per": V0040QosLimitsMaxTresPer.from_dict(obj["per"]) if obj.get("per") is not None else None
        })
        return _obj
