...
class V0040AssocMaxJobs(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "per": V0040AssocMaxJobsPer.from_dict(obj["per"]) if obj.get("per") is not None else None,
            "active": V0040Uint32NoVal.from_dict(obj["active"]) if obj.get("active") is not None else None,
            "accruing": V0040Uint32NoVal.from_dict(obj["accruing"]) if obj.get("accruing") is not None else None,
            "total": V0040Uint32NoVal.from_dict(obj["total"]) if obj.get("total") is not None else None
        })
        return _obj
