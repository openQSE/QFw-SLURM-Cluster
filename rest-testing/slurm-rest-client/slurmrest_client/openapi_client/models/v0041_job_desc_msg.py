...
class V0041JobDescMsg(BaseModel):
    ...
    memory_per_node: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "memory_per_node": V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu.from_dict(obj["memory_per_node"]) if obj.get("memory_per_node") is not None else None,
