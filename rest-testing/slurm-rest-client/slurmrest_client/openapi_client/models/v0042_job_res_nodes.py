...
class V0042JobResNodes(BaseModel):
    ...
    allocation: Optional[List[V0042JobResNode]] = Field(default=None, description="Job resources for a node")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "list": obj.get("list"),
            "whole": obj.get("whole"),
            "allocation": [V0042JobResNode.from_dict(_item) for _item in obj["allocation"]] if obj.get("allocation") is not None else None
        })
        return _obj
