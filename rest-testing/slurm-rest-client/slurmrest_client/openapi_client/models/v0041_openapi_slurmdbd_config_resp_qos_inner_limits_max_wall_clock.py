...
class V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClock(BaseModel):
    """
    V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClock
    """ # noqa: E501
    per: Optional[V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "per": V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPer.from_dict(obj["per"]) if obj.get("per") is not None else None
        })
        return _obj
