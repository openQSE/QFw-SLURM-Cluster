...
class V0043UpdateNodeMsg(BaseModel):
    """
    V0043UpdateNodeMsg
    """ # noqa: E501
    ...
    resume_after: Optional[V0043Uint32NoValStruct] = None
    topology_str: Optional[StrictStr] = Field(default=None, description="Topology")
    weight: Optional[V0043Uint32NoValStruct] = None
    __properties: ClassVar[List[str]] = ["comment", "cpu_bind", "extra", "features", "features_act", "gres", "address", "hostname", "name", "state", "reason", "reason_uid", "resume_after", "topology_str", "weight"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resume_after": V0043Uint32NoValStruct.from_dict(obj["resume_after"]) if obj.get("resume_after") is not None else None,
            "topology_str": obj.get("topology_str"),
            "weight": V0043Uint32NoValStruct.from_dict(obj["weight"]) if obj.get("weight") is not None else None
        })
        return _obj
