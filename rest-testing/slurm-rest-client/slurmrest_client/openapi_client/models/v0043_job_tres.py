...
class V0043JobTres(BaseModel):
    """
    V0043JobTres
    """ # noqa: E501
    allocated: Optional[List[V0043Tres]] = None
    requested: Optional[List[V0043Tres]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "requested": [V0043Tres.from_dict(_item) for _item in obj["requested"]] if obj.get("requested") is not None else None
        })
        return _obj
