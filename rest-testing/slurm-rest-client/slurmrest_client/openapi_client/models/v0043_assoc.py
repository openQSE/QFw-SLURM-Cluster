...
class V0043Assoc(BaseModel):
    """
    V0043Assoc
    """ # noqa: E501
    accounting: Optional[List[V0043Accounting]] = None
    ...
    max: Optional[V0043AssocMax] = None
    id: Optional[StrictInt] = Field(default=None, description="Unique ID (Association ID)")
    ...
    min: Optional[V0043AssocMin] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accounting": [V0043Accounting.from_dict(_item) for _item in obj["accounting"]] if obj.get("accounting") is not None else None,
            "account": obj.get("account"),
            "cluster": obj.get("cluster"),
            "comment": obj.get("comment"),
            "default": V0042AssocDefault.from_dict(obj["default"]) if obj.get("default") is not None else None,
            "flags": obj.get("flags"),
            "max": V0043AssocMax.from_dict(obj["max"]) if obj.get("max") is not None else None,
            "id": obj.get("id"),
            "is_default": obj.get("is_default"),
            "lineage": obj.get("lineage"),
            "min": V0043AssocMin.from_dict(obj["min"]) if obj.get("min") is not None else None,
