...
class V0043StepTime(BaseModel):
    """
    V0043StepTime
    """ # noqa: E501
    elapsed: Optional[StrictInt] = Field(default=None, description="Elapsed time in seconds")
    end: Optional[V0043Uint64NoValStruct] = None
    start: Optional[V0043Uint64NoValStruct] = None
    ...
    __properties: ClassVar[List[str]] = ["elapsed", "end", "start", "suspended", "system", "limit", "total", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "end": V0043Uint64NoValStruct.from_dict(obj["end"]) if obj.get("end") is not None else None,
            "start": V0043Uint64NoValStruct.from_dict(obj["start"]) if obj.get("start") is not None else None,
