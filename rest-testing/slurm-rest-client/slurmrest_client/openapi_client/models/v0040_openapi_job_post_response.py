...
class V0040OpenapiJobPostResponse(BaseModel):
    """
    V0040OpenapiJobPostResponse
    """ # noqa: E501
    results: Optional[List[V0040JobArrayResponseMsgEntry]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [V0040JobArrayResponseMsgEntry.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
