...
class V0043KillJobsRespJob(BaseModel):
    """
    V0043KillJobsRespJob
    """ # noqa: E501
    error: Optional[V0042KillJobsRespJobError] = None
    step_id: StrictStr = Field(description="Job or Step ID that signaling failed")
    job_id: V0043Uint32NoValStruct
    federation: Optional[V0042KillJobsRespJobFederation] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": V0042KillJobsRespJobError.from_dict(obj["error"]) if obj.get("error") is not None else None,
            "step_id": obj.get("step_id"),
            "job_id": V0043Uint32NoValStruct.from_dict(obj["job_id"]) if obj.get("job_id") is not None else None,
            "federation": V0042KillJobsRespJobFederation.from_dict(obj["federation"]) if obj.get("federation") is not None else None
        })
        return _obj
