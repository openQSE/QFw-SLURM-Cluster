...
class V0040QosLimitsMaxWallClock(BaseModel):
    """
    V0040QosLimitsMaxWallClock
    """ # noqa: E501
    per: Optional[V0040QosLimitsMaxWallClockPer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "per": V0040QosLimitsMaxWallClockPer.from_dict(obj["per"]) if obj.get("per") is not None else None
        })
        return _obj
