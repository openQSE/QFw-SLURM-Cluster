...
class V0042Qos(BaseModel):
    ...
    limits: Optional[V0042QosLimits] = None
    name: Optional[StrictStr] = Field(default=None, description="Name")
    preempt: Optional[V0042QosPreempt] = None
    priority: Optional[V0042Uint32NoValStruct] = None
    usage_factor: Optional[V0042Float64NoValStruct] = None
    usage_threshold: Optional[V0042Float64NoValStruct] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "flags": obj.get("flags"),
            "id": obj.get("id"),
            "limits": V0042QosLimits.from_dict(obj["limits"]) if obj.get("limits") is not None else None,
            "name": obj.get("name"),
            "preempt": V0042QosPreempt.from_dict(obj["preempt"]) if obj.get("preempt") is not None else None,
            "priority": V0042Uint32NoValStruct.from_dict(obj["priority"]) if obj.get("priority") is not None else None,
            "usage_factor": V0042Float64NoValStruct.from_dict(obj["usage_factor"]) if obj.get("usage_factor") is not None else None,
            "usage_threshold": V0042Float64NoValStruct.from_dict(obj["usage_threshold"]) if obj.get("usage_threshold") is not None else None
        })
        return _obj
