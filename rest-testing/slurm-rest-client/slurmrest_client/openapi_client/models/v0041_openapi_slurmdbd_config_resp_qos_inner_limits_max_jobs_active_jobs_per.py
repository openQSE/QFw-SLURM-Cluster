...
class V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsActiveJobsPer(BaseModel):
    """
    V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsActiveJobsPer
    """ # noqa: E501
    account: Optional[V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsActiveJobsPerAccount] = None
    user: Optional[V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsActiveJobsPerUser] = None
    __properties: ClassVar[List[str]] = ["account", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "account": V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsActiveJobsPerAccount.from_dict(obj["account"]) if obj.get("account") is not None else None,
            "user": V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsActiveJobsPerUser.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
