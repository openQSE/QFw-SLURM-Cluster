...
class V0042AssocMaxPer(BaseModel):
    """
    V0042AssocMaxPer
    """ # noqa: E501
    account: Optional[V0042AssocMaxPerAccount] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "account": V0042AssocMaxPerAccount.from_dict(obj["account"]) if obj.get("account") is not None else None
        })
        return _obj
