...
class V0042UpdateNodeMsg(BaseModel):
    """
    V0042UpdateNodeMsg
    """ # noqa: E501
    ...
    resume_after: Optional[V0042Uint32NoValStruct] = None
    weight: Optional[V0042Uint32NoValStruct] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resume_after": V0042Uint32NoValStruct.from_dict(obj["resume_after"]) if obj.get("resume_after") is not None else None,
            "weight": V0042Uint32NoValStruct.from_dict(obj["weight"]) if obj.get("weight") is not None else None
        })
        return _obj
