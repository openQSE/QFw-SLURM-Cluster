...
class V0041OpenapiReservationRespReservationsInnerPurgeCompleted(BaseModel):
    """
    V0041OpenapiReservationRespReservationsInnerPurgeCompleted
    """ # noqa: E501
    time: Optional[V0041OpenapiReservationRespReservationsInnerPurgeCompletedTime] = None
    __properties: ClassVar[List[str]] = ["time"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "time": V0041OpenapiReservationRespReservationsInnerPurgeCompletedTime.from_dict(obj["time"]) if obj.get("time") is not None else None
        })
        return _obj
