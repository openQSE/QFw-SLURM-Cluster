...
class V0043JobDescMsg(BaseModel):
    """
    V0043JobDescMsg
    """ # noqa: E501
    ...
    begin_time: Optional[V0043Uint64NoValStruct] = None
    ...
    crontab: Optional[V0043CronEntry] = None
    deadline: Optional[StrictInt] = Field(default=None, description="Latest time that the job may start (UNIX timestamp) (UNIX timestamp or time string recognized by Slurm (e.g., '[MM/DD[/YY]-]HH:MM[:SS]'))")
    ...
    end_time: Optional[StrictInt] = Field(default=None, description="Expected end time (UNIX timestamp) (UNIX timestamp or time string recognized by Slurm (e.g., '[MM/DD[/YY]-]HH:MM[:SS]'))")
    environment: Optional[List[StrictStr]] = None
    rlimits: Optional[V0043JobDescMsgRlimits] = None
    ...
    oom_kill_step: Optional[StrictInt] = Field(default=None, description="Kill whole step in case of OOM in one of the tasks")
    ...
    distribution_plane_size: Optional[V0043Uint16NoValStruct] = None
    ...
    kill_warning_delay: Optional[V0043Uint16NoValStruct] = None
    ...
    required_switches: Optional[V0043Uint32NoValStruct] = None
    segment_size: Optional[V0043Uint16NoValStruct] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "begin_time": V0043Uint64NoValStruct.from_dict(obj["begin_time"]) if obj.get("begin_time") is not None else None,
            "flags": obj.get("flags"),
            ...
            "crontab": V0043CronEntry.from_dict(obj["crontab"]) if obj.get("crontab") is not None else None,
            "deadline": obj.get("deadline"),
            "delay_boot": obj.get("delay_boot"),
            "dependency": obj.get("dependency"),
            "end_time": obj.get("end_time"),
            "environment": obj.get("environment"),
            "rlimits": V0043JobDescMsgRlimits.from_dict(obj["rlimits"]) if obj.get("rlimits") is not None else None,
            ...
            "nice": obj.get("nice"),
            "tasks": obj.get("tasks"),
            "oom_kill_step": obj.get("oom_kill_step"),
            "open_mode": obj.get("open_mode"),
            "reserve_ports": obj.get("reserve_ports"),
            "overcommit": obj.get("overcommit"),
            "partition": obj.get("partition"),
            "distribution_plane_size": V0043Uint16NoValStruct.from_dict(obj["distribution_plane_size"]) if obj.get("distribution_plane_size") is not None else None,
            ...
            "kill_warning_delay": V0043Uint16NoValStruct.from_dict(obj["kill_warning_delay"]) if obj.get("kill_warning_delay") is not None else None,
            ...
            "required_switches": V0043Uint32NoValStruct.from_dict(obj["required_switches"]) if obj.get("required_switches") is not None else None,
            "segment_size": V0043Uint16NoValStruct.from_dict(obj["segment_size"]) if obj.get("segment_size") is not None else None,
