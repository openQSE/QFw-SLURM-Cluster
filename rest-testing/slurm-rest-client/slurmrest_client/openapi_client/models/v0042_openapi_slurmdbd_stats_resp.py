...
class V0042OpenapiSlurmdbdStatsResp(BaseModel):
    """
    V0042OpenapiSlurmdbdStatsResp
    """ # noqa: E501
    statistics: V0042StatsRec
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "statistics": V0042StatsRec.from_dict(obj["statistics"]) if obj.get("statistics") is not None else None,
