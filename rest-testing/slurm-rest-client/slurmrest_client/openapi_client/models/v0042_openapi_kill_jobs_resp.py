...
class V0042OpenapiKillJobsResp(BaseModel):
    """
    V0042OpenapiKillJobsResp
    """ # noqa: E501
    status: List[V0042KillJobsRespJob] = Field(description="List of jobs signal responses")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "status": [V0042KillJobsRespJob.from_dict(_item) for _item in obj["status"]] if obj.get("status") is not None else None,
