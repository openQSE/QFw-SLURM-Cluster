...
class V0042OpenapiJobPostResponse(BaseModel):
    """
    V0042OpenapiJobPostResponse
    """ # noqa: E501
    results: Optional[List[V0042JobArrayResponseMsgEntry]] = None
    ...
    __properties: ClassVar[List[str]] = ["results", "meta", "errors", "warnings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [V0042JobArrayResponseMsgEntry.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
