...
class V0040QosLimits(BaseModel):
    """
    V0040QosLimits
    """ # noqa: E501
    grace_time: Optional[StrictInt] = Field(default=None, description="GraceTime")
    max: Optional[V0040QosLimitsMax] = None
    factor: Optional[V0040Float64NoVal] = None
    min: Optional[V0040QosLimitsMin] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "max": V0040QosLimitsMax.from_dict(obj["max"]) if obj.get("max") is not None else None,
            "factor": V0040Float64NoVal.from_dict(obj["factor"]) if obj.get("factor") is not None else None,
            "min": V0040QosLimitsMin.from_dict(obj["min"]) if obj.get("min") is not None else None
        })
        return _obj
