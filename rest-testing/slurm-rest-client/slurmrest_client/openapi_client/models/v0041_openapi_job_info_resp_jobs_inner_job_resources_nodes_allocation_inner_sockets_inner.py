...
class V0041OpenapiJobInfoRespJobsInnerJobResourcesNodesAllocationInnerSocketsInner(BaseModel):
    """
    V0041OpenapiJobInfoRespJobsInnerJobResourcesNodesAllocationInnerSocketsInner
    """ # noqa: E501
    index: StrictInt = Field(description="Core index")
    cores: List[V0041OpenapiJobInfoRespJobsInnerJobResourcesNodesAllocationInnerSocketsInnerCoresInner] = Field(description="Core in socket")
    __properties: ClassVar[List[str]] = ["index", "cores"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "index": obj.get("index"),
            "cores": [V0041OpenapiJobInfoRespJobsInnerJobResourcesNodesAllocationInnerSocketsInnerCoresInner.from_dict(_item) for _item in obj["cores"]] if obj.get("cores") is not None else None
        })
        return _obj
