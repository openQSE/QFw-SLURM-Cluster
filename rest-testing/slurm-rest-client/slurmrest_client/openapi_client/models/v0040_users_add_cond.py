...
class V0040UsersAddCond(BaseModel):
    """
    V0040UsersAddCond
    """ # noqa: E501
    accounts: Optional[List[StrictStr]] = None
    association: Optional[V0040AssocRecSet] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "association": V0040AssocRecSet.from_dict(obj["association"]) if obj.get("association") is not None else None,
