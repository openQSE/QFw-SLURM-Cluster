...
class V0042PartitionInfoTimeouts(BaseModel):
    """
    V0042PartitionInfoTimeouts
    """ # noqa: E501
    resume: Optional[V0042Uint16NoValStruct] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resume": V0042Uint16NoValStruct.from_dict(obj["resume"]) if obj.get("resume") is not None else None,
            "suspend": V0042Uint16NoValStruct.from_dict(obj["suspend"]) if obj.get("suspend") is not None else None
        })
        return _obj
