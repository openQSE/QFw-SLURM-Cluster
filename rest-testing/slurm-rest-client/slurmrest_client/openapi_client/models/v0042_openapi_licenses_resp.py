...
class V0042OpenapiLicensesResp(BaseModel):
    """
    V0042OpenapiLicensesResp
    """ # noqa: E501
    licenses: List[V0042License]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "licenses": [V0042License.from_dict(_item) for _item in obj["licenses"]] if obj.get("licenses") is not None else None,
