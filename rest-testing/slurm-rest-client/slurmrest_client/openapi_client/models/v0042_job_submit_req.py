...
class V0042JobSubmitReq(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "jobs": [V0042JobDescMsg.from_dict(_item) for _item in obj["jobs"]] if obj.get("jobs") is not None else None,
