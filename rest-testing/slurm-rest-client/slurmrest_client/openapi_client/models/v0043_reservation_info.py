...
class V0043ReservationInfo(BaseModel):
    """
    ...
    burst_buffer: Optional[StrictStr] = Field(default=None, description="BurstBuffer - Burst buffer resources reserved")
    core_count: Optional[StrictInt] = Field(default=None, description="CoreCnt - Number of cores reserved")
    core_specializations: Optional[List[V0043ReservationCoreSpec]] = None
    end_time: Optional[V0043Uint64NoValStruct] = None
    features: Optional[StrictStr] = Field(default=None, description="Features - Expression describing the reservation's required node features")
    flags: Optional[List[StrictStr]] = Field(default=None, description="Flags associated with this reservation")
    groups: Optional[StrictStr] = Field(default=None, description="Groups - Comma-separated list of permitted groups")
    licenses: Optional[StrictStr] = Field(default=None, description="Licenses - Comma-separated list of licenses reserved")
    max_start_delay: Optional[StrictInt] = Field(default=None, description="MaxStartDelay - Maximum time an eligible job not requesting this reservation can delay a job requesting it in seconds")
    name: Optional[StrictStr] = Field(default=None, description="ReservationName - Name of the reservation")
    node_count: Optional[StrictInt] = Field(default=None, description="NodeCnt - Number of nodes reserved")
    node_list: Optional[StrictStr] = Field(default=None, description="Nodes - Comma-separated list of node names and/or node ranges reserved")
    partition: Optional[StrictStr] = Field(default=None, description="PartitionName - Partition used to reserve nodes from")
    purge_completed: Optional[V0043ReservationInfoPurgeCompleted] = None
    start_time: Optional[V0043Uint64NoValStruct] = None
    watts: Optional[V0043Uint32NoValStruct] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "core_specializations": [V0043ReservationCoreSpec.from_dict(_item) for _item in obj["core_specializations"]] if obj.get("core_specializations") is not None else None,
            ...
            "purge_completed": V0043ReservationInfoPurgeCompleted.from_dict(obj["purge_completed"]) if obj.get("purge_completed") is not None else None,
            "start_time": V0043Uint64NoValStruct.from_dict(obj["start_time"]) if obj.get("start_time") is not None else None,
            "watts": V0043Uint32NoValStruct.from_dict(obj["watts"]) if obj.get("watts") is not None else None,
            "tres": obj.get("tres"),
            "users": obj.get("users")
        })
        return _obj
