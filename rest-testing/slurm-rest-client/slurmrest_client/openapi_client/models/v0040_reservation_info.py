...
class V0040ReservationInfo(BaseModel):
    """
    ...
    core_specializations: Optional[List[V0040ReservationCoreSpec]] = None
    ...
    watts: Optional[V0040Uint32NoVal] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "core_specializations": [V0040ReservationCoreSpec.from_dict(_item) for _item in obj["core_specializations"]] if obj.get("core_specializations") is not None else None,
            ...
            "purge_completed": V0040ReservationInfoPurgeCompleted.from_dict(obj["purge_completed"]) if obj.get("purge_completed") is not None else None,
            "start_time": V0040Uint64NoVal.from_dict(obj["start_time"]) if obj.get("start_time") is not None else None,
            "watts": V0040Uint32NoVal.from_dict(obj["watts"]) if obj.get("watts") is not None else None,
            "tres": obj.get("tres"),
            "users": obj.get("users")
        })
        return _obj
