...
class V0043QosLimitsMax(BaseModel):
    """
    V0043QosLimitsMax
    """ # noqa: E501
    active_jobs: Optional[V0043QosLimitsMaxActiveJobs] = None
    jobs: Optional[V0043QosLimitsMaxJobs] = None
    tres: Optional[V0043QosLimitsMaxTres] = None
    wall_clock: Optional[V0043QosLimitsMaxWallClock] = None
    accruing: Optional[V0043QosLimitsMaxJobsActiveJobs] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "active_jobs": V0043QosLimitsMaxActiveJobs.from_dict(obj["active_jobs"]) if obj.get("active_jobs") is not None else None,
            "jobs": V0043QosLimitsMaxJobs.from_dict(obj["jobs"]) if obj.get("jobs") is not None else None,
            "tres": V0043QosLimitsMaxTres.from_dict(obj["tres"]) if obj.get("tres") is not None else None,
            "wall_clock": V0043QosLimitsMaxWallClock.from_dict(obj["wall_clock"]) if obj.get("wall_clock") is not None else None,
            "accruing": V0043QosLimitsMaxJobsActiveJobs.from_dict(obj["accruing"]) if obj.get("accruing") is not None else None
        })
        return _obj
