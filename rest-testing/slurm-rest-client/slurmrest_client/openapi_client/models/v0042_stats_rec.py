...
class V0042StatsRec(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rollups": V0042RollupStats.from_dict(obj["rollups"]) if obj.get("rollups") is not None else None,
            "RPCs": [V0042StatsRpc.from_dict(_item) for _item in obj["RPCs"]] if obj.get("RPCs") is not None else None,
            "users": [V0042StatsUser.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
        return _obj
