...
class V0040QosLimitsMaxTresMinutes(BaseModel):
    """
    V0040QosLimitsMaxTresMinutes
    """ # noqa: E501
    per: Optional[V0040QosLimitsMaxTresMinutesPer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "per": V0040QosLimitsMaxTresMinutesPer.from_dict(obj["per"]) if obj.get("per") is not None else None
        })
        return _obj
