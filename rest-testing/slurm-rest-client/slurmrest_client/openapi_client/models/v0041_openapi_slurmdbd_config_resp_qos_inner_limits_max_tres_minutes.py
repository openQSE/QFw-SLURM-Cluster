...
class V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxTresMinutes(BaseModel):
    """
    V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxTresMinutes
    """ # noqa: E501
    per: Optional[V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxTresMinutesPer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "per": V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxTresMinutesPer.from_dict(obj["per"]) if obj.get("per") is not None else None
        })
        return _obj
